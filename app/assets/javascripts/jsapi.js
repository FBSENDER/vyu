function ykjsapi(){
  ...
  f = {
    ...
    uniReport: function(b) {
      ...
      b.version = "2015/12/0714:04:42".replace(/[-: ]/g, "");
  ...
  l.request = function() {
    ...
    c.config.partner_config && c.config.partner_config.stealsign && (this._url += "&r=" + encodeURIComponent(c.config.partner_config.stealsign));
        ...
        if (null != d.error) {
          if ( - 202 == d.error.code || -203 == d.error.code) f.sendErrorReport(4E3);
            ...
            if ( - 402 == d.error.code) {
              ...
              f.showError(c.config.parentBox, "\u7528\u6237\u6ca1\u6709\u6743\u9650\u89c2\u770b,\u8bf7\u8fd4\u56de\u4e3b\u7ad9\u64ad\u653e");
              return
            }
  ...
  ea.prototype = {
    ...
    this.FX.transitions = {
      ...
      easeOut: function(b, c, d, e) {
        return d * Math.sin(b / e * (Math.PI / 2)) + c
      },
      easeInOut: function(b, c, d, e) {
    ...
    this.FX.prototype = {
      start: function() {
        ...
        this.timer = setInterval(function() {
          ...
          c < b.time + b.duration ? (b.elapsed = c - b.time, b.setCurrentFrame()) : (b.frame = b.endAttr, b.complete());
          b.setAttributes()
        },
        10)
      },
      ease: function(b, c) {
        return FX.transitions[this.transition](this.elapsed, b, c - b, this.duration)
      },
      complete: function() {
      ...
      setCurrentFrame: function() {
        for (var b in this.startAttr) if (this.startAttr[b] instanceof Array) {
          this.frame[b] = [];
          for (var c = 0; c < this.startAttr[b].length; c++) this.frame[b][c] = this.ease(this.startAttr[b][c], this.endAttr[b][c])
  ...
  FX.transitions.quartIn = function(b, c, e, g) {
    return e * (b /= g) * b * b * b + c
  };
  FX.transitions.quartOut = function(b, c, e, g) {
    return - e * ((b = b / g - 1) * b * b * b - 1) + c
  };
  FX.transitions.quartInOut = function(b, c, e, g) {
    return 1 > (b /= g / 2) ? e / 2 * b * b * b * b + c: -e / 2 * ((b -= 2) * b * b * b - 2) + c
  };
  FX.transitions.quintIn = function(b, c, e, g) {
    return e * (b /= g) * b * b * b * b + c
  };
  FX.transitions.quintOut = function(b, c, e, g) {
    return e * ((b = b / g - 1) * b * b * b * b + 1) + c
  };
  FX.transitions.quintInOut = function(b, c, e, g) {
    return 1 > (b /= g / 2) ? e / 2 * b * b * b * b * b + c: e / 2 * ((b -= 2) * b * b * b * b + 2) + c
  };
  FX.transitions.expoIn = function(b, c, e, g) {
    return 0 == b ? c: e * Math.pow(2, 10 * (b / g - 1)) + c - 0.001 * e
  };
  FX.transitions.expoOut = function(b, c, e, g) {
    return b == g ? c + e: 1.001 * e * ( - Math.pow(2, -10 * b / g) + 1) + c
  };
  FX.transitions.expoInOut = function(b, c, e, g) {
    return 0 == b ? c: b == g ? c + e: 1 > (b /= g / 2) ? e / 2 * Math.pow(2, 10 * (b - 1)) + c - 5.0E-4 * e: 1.0005 * (e / 2) * ( - Math.pow(2, -10 * --b) + 2) + c
  };
  ...
  V.prototype = {
    ...
    sendCustomLoadedTime: function(b) {
      b = {
        ...
        cost: b,
        ver: "2015/12/0714:04:42".replace(/[-:]/g, "")
  ...
  C("http://player.youku.com/h5player/play.css?ver=" + "2015/12/0714:04:42".replace(/[-:]/g, ""), "css");
  var aa = function(b) {
    this._id = b.id;
    this._pid = b.pid || "";
    this._url = b.url;
